...
const About = () => {
  return (
    <div className="container-thin bg-dark text-white pb-0" id="about">
      <div className="flex flex-col items-center justify-between gap-y-8 min-w-full">
        ...
        <div className="flex flex-row items-center justify-between gap-x-4 min-w-full">
